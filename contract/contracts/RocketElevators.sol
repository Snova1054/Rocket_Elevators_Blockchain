...
contract RocketElevators is ERC721Enumerable, Ownable {
    using Strings for uint256;
    address RocketElevatorsTokenAddress = 0x3b8F02Aa259f1c55fC2afaFF9cC3695074Ff80EB;
    string baseURI;
    ...
    function mint(uint256 _mintAmount) public payable {
        uint256 supply = totalSupply();
        require(endSale > block.timestamp);
