...
contract("RocketElevators", (accounts) => {
  ...
  describe("deployement", async() => {
    ...
    it("has a name", async () => {
      ...
      assert.equal(name, "RocketElevatorsPepe")
    })
    ...
    it("has a correct white list", async () => {
      ...
      assert.equal(whitelistmember1, "0xd1679bB3543e8aD195FF9f3Ac3436039bA389237")
      assert.equal(whitelistmember2, "0x49C99dB83eA1cDa354b718A4Be90f4B1C3Dc94A4")
    })
  });
});